/**
 * ==========================================================================
 * MÓDULO: Mural de Carinho (Sincronização Firebase Firestore) [1, 3]
 * Sincroniza em tempo real as fotos e reações do memorial.
 * ==========================================================================
 */
...
const EVENTO_ID = "maria-eduarda"; // Identificador exclusivo no banco

/**
 * Escuta as atualizações do banco de dados em tempo real na nuvem do Firebase [3].
 */
...
/**
 * Envia as informações do formulário para o Firestore [3].
 */
